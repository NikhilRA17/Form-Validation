...
const AddForm = () => {
  ...
  return (
    <div className="App" style={{ width:'1535px', padding:'20px', textAlign:'center' }}>

          <div style={{border:'2px solid grey', backgroundColor:'white', borderRadius:'10px', boxShadow: '10px 10px 5px black' , textAlign:'center', margin:'auto', width:'450px'}}>
              ...
              <br></br>
              <button onClick={handleShow} className="btn btn-success">Submit Comment</button>
          </div>
